...
SVC_NAME=`systemd-escape --path "vsts.agent.practice-dev-organization.Default.ARTEMIS.service"`
SVC_DESCRIPTION="Azure Pipelines Agent (practice-dev-organization.Default.ARTEMIS)"
