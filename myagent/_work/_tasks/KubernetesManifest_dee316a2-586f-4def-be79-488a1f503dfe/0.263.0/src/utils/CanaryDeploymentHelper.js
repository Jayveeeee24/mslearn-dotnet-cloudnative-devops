...
function isSpecContainsReplicas(kind) {
    return !(0, StringComparison_1.isEqual)(kind, kubernetesconstants_1.KubernetesWorkload.pod, StringComparison_1.StringComparer.OrdinalIgnoreCase) &&
        !(0, StringComparison_1.isEqual)(kind, kubernetesconstants_1.KubernetesWorkload.daemonSet, StringComparison_1.StringComparer.OrdinalIgnoreCase) &&
...
function deleteCanaryAndBaselineObjects(kubectl, files, includeServices) {
    var kindNameMap = {};
